					...
					<table class="table table-hover table-bordered table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									{{ $p_reminder->user_attended_fn ? ucwords(optional($p_reminder->user_attended_fn)->name) : '-' }}
									{{ $p_reminder->user_attended_2 ? ' & ' . ucwords(optional($p_reminder->user_attended_2_fn)->name) : '' }}
								</td>
